...
export const METRICS: MetricDef[] = [
  ...
  { key: "overnight", label: "Overnight", explain: "Work handed over late and reviewed the next morning", overlay: true, night: true, tone: "night" },
  { key: "nightOwl", label: "Night owl", explain: "Prompts sent between 22:00 and 05:00", overlay: true, night: true, tone: "night" },
  ...
  { key: "caps", label: "Caps lock", explain: "SHOUTING at it — two or more words in capitals", overlay: true, tone: "heat" },
